      ...
      <section className="relative overflow-hidden py-16">
        <div className="mx-auto mt-10 grid gap-20 px-4 lg:grid-cols-[1.1fr_0.9fr] sm:px-8 border">
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <h1 className="max-w-3xl text-3xl jetbrains-mono leading-10 md:leading-[60px] text-slate-800 md:text-5xl">
                Accept <span className="text-emerald-400">Crypto</span> Payments
                Like Stripe
              </h1>
              <p className="max-w-xl leading-8 text-slate-800">
                Build professional checkout experiences for the on-chain
                economy. Global settlement in seconds, API-first architecture,
          ...
          <div className="relative flex p-2 sm:h-[470px] sm:w-[470px] border-2 border-slate-800 shadow-2xl shadow-slate-950/30">
            ...
            <div
              className="absolute left-0 md:-left-10 -bottom-20 md:-bottom-10
      ...
      >
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3"> 
          <article className="border border-slate-800 p-8 brutal">
            <ShoppingCart
              size={"30px"}
              className="text-black bg-[#10b981] p-3 box-content"
            />
            <p className="text-sm uppercase tracking-[0.32em] text-black mt-4">
              Embedded Checkout
            </p>
            <p className="mt-4 text-sm leading-7 text-slate-700">
              Flexible on-chain checkout with instant approvals, advanced UX,
              and seamless wallet support.
            </p>
          </article>
          <article className="border border-slate-800 p-8 brutal">
            <Code
            ...
            <p className="mt-4 text-sm leading-7 text-slate-700">
              Robust SDK routing, webhook delivery, and 1-click contract
              orchestration for payments.
            </p>
          </article>
          <article className="border border-slate-800 p-8 brutal">
            <Zap
            ...
            <p className="mt-4 text-sm leading-7 text-slate-700">
              Zero fiat rails, zero waiting, and real-time transaction finality
              across chains.
            </p>
          </article>
        </div>
        ...
        <div className="border flex flex-row justify-center border-slate-500/70 text-black p-8 grid gap-10 gap-13 sm:grid-cols-2">
          <div className="flex flex-col gap-5 w-full">
            ...
            <p className="text-slate-700">
              A robust, typed SDK that works exactly like the tools you already
              use. From webhooks to customized metadata, Norelix handles the
              complexity of the chain while you build the product.
            </p>
  ...
  `}
      ...
      <section className="py-20 text-center">
        <div className="py-8 px-4">
          ...
          <p className="text-black text-[14px]">
            The most secure payment infrastructure on Ethereum, Polygon, and
            Solana. Verified by top security firms.
          </p>
        </div>
            ...
            <div className="grid text-slate-300 jetbrains-mono mt-5">
              <div className="">
                {[
                  ...
                  <div
                    key={event.TX_ID}
                    className="flex items-center justify-between gap-2 py-2 text-[12px] sm:text-[14px] text-slate-300 jetbrains-mono border-b border-slate-600"
                  >
                    <div className="">
          ...
          <div className="min-w-0 space-y-6">
            <div className="border flex flex-col gap-5 border-slate-500/70 bg-gray-200 text-black p-8">
              <p className="text-sm uppercase tracking-[0.32em]">
                Global Gas-Less Rails
              </p>
              <p className="max-w-xl text-sm leading-7">
                Norelix abstracts gas fees for your users, allowing for a
                seamless USDC experience without needing native chain tokens.
              </p>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="border border-slate-500/70 p-6 text-black gap-3 flex flex-col justify-center items-center">
                ...
                <p className="text-[14px] uppercase tracking-[0.32em] font-bold">
                  Certified Security
                </p>
                <p className="text-[14px] text-center">
                  Audited smart contracts and merchant-level webhooks with
                  real-time events.
                </p>
              </div>
              <div className="border border-slate-500/70 p-6 text-black gap-3 flex flex-col justify-center items-center">
                ...
                <p className="text-[14px] text-center">
                  Non-custodial key management for every merchant.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 sm:px-8">
        <div className="bg-[#064e3b] p-10 py-14px text-center text-slate-100">
          <p className="text-sm uppercase tracking-[0.32em] text-emerald-100">
          ...
          <div className="mx-auto mt-8 flex max-w-md flex-col gap-4 sm:flex-row sm:justify-center">
            <Link to="/signin">
              <button className="bg-white w-full px-6 py-3 text-sm font-semibold text-black transition hover:bg-slate-300">
                Create Free Account
              </button>
            </Link>
